 ...
 * for. Fixed by threading it through as a real 4th syscall argument instead of discarding it --
 * see modules/oxfs's own `oxfs_open` doc comment on the OxideBSD side for the kernel-side half of
 * this fix.
 *
